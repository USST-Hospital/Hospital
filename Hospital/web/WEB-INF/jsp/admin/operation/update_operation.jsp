...
<head>
    ...
    <script src="${pageContext.request.contextPath}/javascript/change_operation.js"></script>
    ...
    <div>
        <table class="table table-bordered" >
            <tr>
                ...
                <tr>
                    <td id="operationId">${ operation.id }</td>
    ...
    <div class="col-md-8 col-md-offset-2">
        <form action="../../AdminCourse?o=a" method="post" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select class="form-control" id="adminDoctor" >
                        <option value="-1">未选择</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-offset-6 col-sm-6">
                    <button id="adminAddOpeartion" type="button" class="btn btn-success">确定修改</button>
                </div>
            </div>
